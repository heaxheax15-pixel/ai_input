...
### القسم 5 — غير مُختبَر آلياً: يتطلب جلسة عرض حقيقية
- لا توجد في هذه البيئة شاشة حقيقية ولا جلسة GUI قابلة للتحقق، لذلك لا يمكن إثبات أن تدفق الالتقاط الفعلي، كتابة الصورة إلى الحافظة، لصقها، ثم الضغط على Enter في تطبيق الطرفية قد تم تشغيله فعلياً.